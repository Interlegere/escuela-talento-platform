...
export type Testimonio = {
  ...
  // Cuando el proyecto ya es conocido (aparece en el carrusel de logos), el
  // logo refuerza más que una foto de la persona — se usa en vez de `foto`.
  ...
  testimonios: [
    {
      ...
      texto:
        "Nicolás me ayudó a descubrir el propósito que impulsa mi carrera. Lograr que Altia crezca, funcione y se consolide es, sin duda, un logro compartido.",
    },
    {
      nombre: "Florencia",
      texto:
